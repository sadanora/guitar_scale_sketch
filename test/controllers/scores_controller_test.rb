...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create score' do
    assert_difference('Score.count') do
      post scores_url, params: { score: { id: @score.id, is_public: @score.is_public, title: @score.title } }
    end
  ...
  test 'should update score' do
    patch score_url(@score), params: { score: { id: @score.id, is_public: @score.is_public, title: @score.title } }
